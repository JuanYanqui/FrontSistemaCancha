...
@Component({
  selector: 'app-register-bodega',
  templateUrl: './register-bodega.component.html',
  styleUrls: ['./register-bodega.component.css']
})
export class RegisterBodegaComponent implements OnInit {
  ...
  loadFormGroup() {
    this.bodegaForm = this.formBuilder.group({
      nombre: ['', [Validators.required, Validators.pattern(this.validPattern)]],

...
export class GestionReportesComponent implements OnInit {
  ...
  constructor(private productoService: ProductoService, private toastr: ToastrService, private itemPedidoService: ItemPedidoService, private usuarioService: UsuarioService, private pedidoService: PedidoService, private router: Router) { }

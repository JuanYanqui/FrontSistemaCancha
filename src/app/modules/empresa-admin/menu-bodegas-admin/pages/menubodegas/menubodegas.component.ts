...
@Component({
  selector: 'app-menubodegas',
  templateUrl: './menubodegas.component.html',
  styleUrls: ['./menubodegas.component.css']
})
...
goToR($event: any) :void{
  ...
  this.router.navigate(['/empresa-adm/bodega/reg-bodega'])
  console.log($event)
...
goTo($event: any) :void{
  ...
  this.router.navigate(['/empresa-adm/bodega/edit-bodega'])
  console.log($event)
...
goT($event: any) :void{
  ...
  this.router.navigate(['/empresa-adm/bodega/list-bodega'])
  console.log($event)

...
import { UnidadMedida } from 'src/app/core/interfaces/unidad-medida';
...
@Component({
  selector: 'app-add-pucharse',
  templateUrl: './add-pucharse.component.html',
  styleUrls: ['./add-pucharse.component.css']
})
export class AddPucharseComponent {
  @Input() someInput: any;
  empresa = new Empresa();
  formw = NgForm;

...
@Component({
  selector: 'app-list-gestion-pedidos',
  templateUrl: './list-gestion-pedidos.component.html',
  styleUrls: ['./list-gestion-pedidos.component.css']
})
export class ListGestionPedidosComponent {
